// =======================
//  FICHERO - OCUPADOEXCEPCION.H
// =======================

#ifndef OCUPADOEXCEPCION_H
#define OCUPADOEXCEPCION_H
...
// ================================================================
   ...
   * </PRE>
   */
class OcupadoExcepcion : public Excepcion
{
  public:
  ...
  /**
      ...
      */
      OcupadoExcepcion(const UWordType uwNumLinea,const char* uwNomFichero,
      ...
      *   @exception Ninguno
      */
      virtual ~OcupadoExcepcion();
};

#endif // OCUPADOEXCEPCION_H

// ===========================
//  FIN DEL FICHERO - OCUPADOEXCEPCION.H
// ===========================
