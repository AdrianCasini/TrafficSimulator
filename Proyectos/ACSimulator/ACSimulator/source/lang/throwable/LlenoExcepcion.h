...
#ifndef LLENOEXCEPCION_H
#define LLENOEXCEPCION_H
...
// ================================================================
   ...
   * <PRE>
   *
   * FICHERO: LLENOEXCEPCION.H
   *
   * DESCRIPCION:
   *   Excepciones lanzadas cuando no se pueden tener mas recursos.
   *
   ...
   * </PRE>
   */
class LlenoExcepcion : public Excepcion
{
  public:
  ...
  /**
      ...
      */
      LlenoExcepcion(const UWordType uwNumLinea,const char* uwNomFichero,
      ...
      *   @exception Ninguno
      */
      virtual ~LlenoExcepcion();
};

#endif // LLENOEXCEPCION_H

// ===========================
//  FIN DEL FICHERO - LLENOEXCEPCION.H
// ===========================
