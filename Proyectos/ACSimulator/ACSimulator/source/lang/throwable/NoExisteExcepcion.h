// =======================
//  FICHERO - NOEXISTEEXCEPCION.H
// =======================

#ifndef NOEXISTEEXCEPCION_H
#define NOEXISTEEXCEPCION_H
...
// ================================================================
   ...
   *
   * DESCRIPCION:
   *   Excepciones lanzadas cuando no se encuentra un elemento o dato.
   *
   ...
   * </PRE>
   */
class NoExisteExcepcion : public Excepcion
{
  public:
  ...
  /**
      ...
      */
      NoExisteExcepcion(const UWordType uwNumLinea,const char* uwNomFichero,
      ...
      *   @exception Ninguno
      */
      virtual ~NoExisteExcepcion();
};

#endif // NOEXISTEEXCEPCION_H

// ===========================
//  FIN DEL FICHERO - NOEXISTEEXCEPCION.H
// ===========================
