// =======================
//  FICHERO - CORROMPIDOEXCEPCION.H
// =======================

#ifndef CORROMPIDOEXCEPCION_H
#define CORROMPIDOEXCEPCION_H
...
// ================================================================
   ...
   *
   * DESCRIPCION:
   *   Excepciones lanzadas cuando algun dispositivo esta corrompido.
   *
   * FECHA CREACION: 20-05-2005
   *
   * AUTOR DISENYO:
   *
   ...
   * </PRE>
   */
class CorrompidoExcepcion : public Excepcion
{
  public:
  /**
      ...
      */
    CorrompidoExcepcion(const UWordType uwNumLinea,const char* uwNomFichero,
...
/**
  ...
  * </PRE>
  */
  virtual ~CorrompidoExcepcion();
};

#endif // CORROMPIDOEXCEPCION_H

// ===========================
//  FIN DEL FICHERO - CORROMPIDOEXCEPCION.H
// ===========================
