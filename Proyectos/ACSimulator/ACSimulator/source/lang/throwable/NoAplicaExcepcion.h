// =======================
//  FICHERO - NOAPLICAEXCEPCION.H
// =======================

#ifndef NOAPLICAEXCEPCION_H
#define NOAPLICAEXCEPCION_H
...
// ================================================================
   ...
   *
   * DESCRIPCION:
   *   Excepciones lanzadas cuando no la accion a realizar no es posible o
   *   no tiene sentido.
   *
   ...
   * </PRE>
   */
class NoAplicaExcepcion : public Excepcion
{
  public:
  ...
  /**
      ...
      */
      NoAplicaExcepcion(const UWordType uwNumLinea,const char* uwNomFichero,
      ...
      *   @exception Ninguno
      */
      virtual ~NoAplicaExcepcion();
};

#endif // NOAPLICAEXCEPCION_H

// ===========================
//  FIN DEL FICHERO - NOAPLICAEXCEPCION.H
// ===========================
