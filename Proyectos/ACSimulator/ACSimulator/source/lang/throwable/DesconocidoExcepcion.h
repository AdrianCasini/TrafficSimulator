// =======================
//  FICHERO - DESCONOCIDOEXCEPCION.H
// =======================

#ifndef DESCONOCIDOEXCEPCION_H
#define DESCONOCIDOEXCEPCION_H
...
// ================================================================
   ...
   *
   * DESCRIPCION:
   *   Excepciones lanzadas cuando una funcion retorna un valor de error
   *   desconocido en las especificaciones de la misma.
   *
   ...
   * </PRE>
   */
class DesconocidoExcepcion : public Excepcion
{
  public:
  /**
      ...
      */
    DesconocidoExcepcion(const UWordType uwNumLinea,const char* uwNomFichero,
...
/**
  ...
  * </PRE>
  */
  virtual ~DesconocidoExcepcion();
};

#endif // DESCONOCIDOEXCEPCION_H

// ===========================
//  FIN DEL FICHERO - DESCONOCIDOEXCEPCION.H
// ===========================
