// =======================
//  FICHERO - PARAMETROEXCEPCION.H
// =======================

#ifndef PARAMETROEXCEPCION_H
#define PARAMETROEXCEPCION_H
...
// ================================================================
   ...
   *
   * DESCRIPCION:
   *   Excepciones lanzadas donde una funcion o metodo recibe un parametro
   *   incorrecto.
   *
   ...
   * </PRE>
   */
class ParametroExcepcion : public Excepcion
{
  public:
  ...
  /**
      ...
      */
      ParametroExcepcion(const UWordType uwNumLinea,const char* uwNomFichero,
      ...
      *   @exception Ninguno
      */
      virtual ~ParametroExcepcion();
};

#endif // PARAMETROEXCEPCION_H

// ===========================
//  FIN DEL FICHERO - PARAMETROEXCEPCION.H
// ===========================
