// =======================
//  FICHERO - IOEXCEPCION.H
// =======================

#ifndef IOEXCEPCION_H
#define IOEXCEPCION_H
...
// ================================================================
   ...
   *
   * DESCRIPCION:
   *   Excepciones lanzadas sobre operaciones de entrada y salida.
   *
   ...
   * </PRE>
   */
class IOExcepcion : public Excepcion
{
  public:
  ...
  /**
      ...
      */
      IOExcepcion(const UWordType uwNumLinea,const char* uwNomFichero,
