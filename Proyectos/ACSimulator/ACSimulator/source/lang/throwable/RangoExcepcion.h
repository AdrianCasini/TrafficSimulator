// =======================
//  FICHERO - RANGOEXCEPCION.H
// =======================

#ifndef RANGOEXCEPCION_H
#define RANGOEXCEPCION_H
...
// ================================================================
   ...
   *
   * DESCRIPCION:
   *   Excepciones lanzadas donde se supera el limite de una variable o
   *   elemento.
   *
   ...
   * </PRE>
   */
class RangoExcepcion : public Excepcion
{
  public:
  /**
      ...
      */
      RangoExcepcion(const UWordType uwNumLinea,const char* uwNomFichero,
      ...
      *   @exception Ninguno
      */
      virtual ~RangoExcepcion();
};

#endif // RANGOEXCEPCION_H

// ===========================
//  FIN DEL FICHERO - RANGOEXCEPCION.H
// ===========================
