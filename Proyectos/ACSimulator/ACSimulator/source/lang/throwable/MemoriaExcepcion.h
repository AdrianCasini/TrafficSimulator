// =======================
//  FICHERO - MEMORIAEXCEPCION.H
// =======================

#ifndef MEMORIAEXCEPCION_H
#define MEMORIAEXCEPCION_H
...
// ================================================================
   ...
   *
   * DESCRIPCION:
   *   Excepciones lanzadas con problemas de memoria
   *
   ...
   * </PRE>
   */
class MemoriaExcepcion : public Excepcion
{
  public:
  ...
  /**
      ...
      */
      MemoriaExcepcion(const UWordType uwNumLinea,const char* uwNomFichero,
      ...
      *   @exception Ninguno
      */
      virtual ~MemoriaExcepcion();
};

#endif // MEMORIAEXCEPCION_H

// ===========================
//  FIN DEL FICHERO - MEMORIAEXCEPCION.H
// ===========================
