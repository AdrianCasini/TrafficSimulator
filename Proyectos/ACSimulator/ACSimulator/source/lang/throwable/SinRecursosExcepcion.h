// =======================
//  FICHERO - SINRECURSOSEXCEPCION.H
// =======================

#ifndef SINRECURSOSEXCEPCION_H
#define SINRECURSOSEXCEPCION_H
...
// ================================================================
   ...
   *
   * DESCRIPCION:
   *   Excepciones lanzadas donde cuando no es posible de disponer de mas recursos
   *   o elementos.
   *
   ...
   * </PRE>
   */
class SinRecursosExcepcion : public Excepcion
{
  public:
  /**
      ...
      */
      SinRecursosExcepcion(const UWordType uwNumLinea,const char* uwNomFichero,
      ...
      *   @exception Ninguno
      */
      virtual ~SinRecursosExcepcion();
};

#endif // SINRECURSOSEXCEPCION_H

// ===========================
//  FIN DEL FICHERO - SINRECURSOSEXCEPCION.H
// ===========================
