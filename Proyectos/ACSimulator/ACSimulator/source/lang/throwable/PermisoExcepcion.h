// =======================
//  FICHERO - PERMISOEXCEPCION.H
// =======================

#ifndef PERMISOEXCEPCION_H
#define PERMISOEXCEPCION_H
...
// ================================================================
   ...
   *
   * DESCRIPCION:
   *   Excepciones lanzadas donde una funcion o metodo recibe no se puede
   *   ejecutar porque el usuario no tiene acceso al recurso.
   *
   ...
   * </PRE>
   */
class PermisoExcepcion : public Excepcion
{
  public:
  /**
      ...
      */
      PermisoExcepcion(const UWordType uwNumLinea,const char* uwNomFichero,
      ...
      *   @exception Ninguno
      */
      virtual ~PermisoExcepcion();
};

#endif // PERMISOEXCEPCION_H

// ===========================
//  FIN DEL FICHERO - PERMISOEXCEPCION.H
// ===========================
