...
const char* BaseDatos::NOMBRE_BD   = "hgway";
const char* BaseDatos::USUARIO     = "acasini";
	...
	const Cadena& usuario, const Cadena& contrasenya, int timeout)
{
	...
	if (this->mDB == NULL || PQstatus(this->mDB) != CONNECTION_OK)
	{
		if (this->mDB != NULL)
		{
			//STrz::error(ConstTraza::T_TRAZA_BD, );
		...
		//STrz::warning(ConstTraza::T_TRAZA_BD,
	...
	else
	{
		...
		//STrz::debug (ConstTraza::T_TRAZA_BD, "Conexion establecida");
